...
export default function Hero() {
  ...
  return (
    <div className="bg-white h-screen w-screen overflow-hidden flex justify-center items-center">
      ...
      <div className="relative isolate px-6 lg:px-8 flex justify-center items-center h-full w-full">
        <div
        ...
        <div className="mx-auto max-w-2xl flex justify-center items-center flex-col h-full w-full">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              &#x1F389; Announcing our next chapter in serving you better!
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Unlock the Power of Digital Solutions
            </h1>
